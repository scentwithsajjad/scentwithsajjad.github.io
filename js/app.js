...
const orderUrl=(p,size='5ML')=>waNumber?`https://wa.me/${waNumber}?text=${encodeURIComponent(`Hi @scentwithsajjad, I'd like to order ${p.name} (${size}) by ${p.brand}. 
 Please help me place my order.`)}`:`https://wa.me/?text=${encodeURIComponent(`Hi Sajjad, I'd like ${p.name} (${size}) by ${p.brand}. Please share availability and price.`)}`;
